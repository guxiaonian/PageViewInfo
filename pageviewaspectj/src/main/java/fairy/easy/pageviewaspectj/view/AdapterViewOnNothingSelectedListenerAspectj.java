 ...
 */
@Aspect
public class AdapterViewOnNothingSelectedListenerAspectj extends BaseAspectj {

    /**
     * android.widget.AdapterView.OnItemSelectedListener.onNothingSelected(android.widget.AdapterView,android.view.View,int,long)
     *
     * @param joinPoint 切面
     */
    @After("execution(* android.widget.AdapterView.OnItemSelectedListener.onNothingSelected(android.widget.AdapterView,android.view.View,int,long))")
    public void onNothingSelectedAOP(JoinPoint joinPoint) {
        baseClick(joinPoint);
    }
    ...
    void onNothingSelected(JoinPoint joinPoint) {
        try {
            ...
            PageViewAspectjHelper.with().getBasePageViewListener().onNothingSelected((AdapterView) object);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
